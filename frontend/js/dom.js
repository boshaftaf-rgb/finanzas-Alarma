...
export const els = {
  ...
  emaPairFields: document.getElementById("ema-pair-fields"),
  emaSingleFields: document.getElementById("ema-single-fields"),
  emaFast: document.getElementById("ema-fast"),
  emaSlow: document.getElementById("ema-slow"),
  emaSinglePeriod: document.getElementById("ema-single-period"),
  emaSingleHint: document.getElementById("ema-single-hint"),
  ...
  emaCrossHint: document.getElementById("ema-cross-hint"),
